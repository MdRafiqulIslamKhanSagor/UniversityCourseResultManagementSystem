...
namespace UniversityCourseResultManagementSystem.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentId,StudentName,StudentEmail,StudentContactNo,Date,StudentAddress,StudentRegNo,DepartmentId")] Student student)
        {
